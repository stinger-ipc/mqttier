...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    #[cfg(feature = "metrics")]
    {
        ...
        println!("\n=== Initial Metrics ===");
        println!("Connection attempts: {}", initial_metrics.connection_attempts);
        println!("Successful connections: {}", initial_metrics.successful_connections);
        ...
        println!("Successful connections: {}", final_metrics.successful_connections);
        ...
        println!("Total published: {}", final_metrics.total_messages_published());
        ...
        println!("Total received: {}", final_metrics.total_messages_received());
        println!("Total bytes received: {}", final_metrics.total_bytes_received);
        
        println!("\n--- Performance Metrics ---");
        println!("Pending publishes: {}", final_metrics.pending_publish_count);
        println!("Average publish latency: {} ms", final_metrics.avg_publish_latency_ms);
        println!("Max publish latency: {} ms", final_metrics.max_publish_latency_ms);
        println!("Min publish latency: {} ms", final_metrics.min_publish_latency_ms);
        ...
        println!("Subscription requests: {}", final_metrics.subscription_requests);
        println!("Subscription failures: {}", final_metrics.subscription_failures);
        
        // Demonstrate metrics reset
        println!("\n=== Resetting metrics ===");
        client.reset_metrics();
        let reset_metrics = client.get_metrics();
        println!("Messages published after reset: {}", reset_metrics.total_messages_published());
    }
